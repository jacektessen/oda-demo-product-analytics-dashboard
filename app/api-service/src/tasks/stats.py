...
async def periodic_stats_update(redis_instance):
        ...
        try:
            ...
            if products:
                ...
                if stats:
                    ...
                    redis_instance.setex(temp_key, CACHE_TTL, json.dumps(stats.dict()))

                    # Atomic swap
                    redis_instance.rename(temp_key, "product:stats")
...
async def initial_stats_update(redis_instance):
